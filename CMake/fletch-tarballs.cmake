...
if (fletch_ENABLE_GDAL OR fletch_ENABLE_ALL_PACKAGES)
  set(GDAL_SELECT_VERSION 3.2.1 CACHE STRING "Select the major version of GDAL to build.")
  set_property(CACHE GDAL_SELECT_VERSION PROPERTY STRINGS "2.3.2" "1.11.5" "3.2.1")
  message(STATUS "GDAL Select version: ${GDAL_SELECT_VERSION}")
  if (GDAL_SELECT_VERSION VERSION_EQUAL 3.2.1)
    set(GDAL_version "3.2.1")
    set(GDAL_url "http://download.osgeo.org/gdal/${GDAL_version}/gdal-${GDAL_version}.tar.gz")
    set(GDAL_md5 "142dd8a1dc6a598b7e60c1e9e8a1b8ed")
